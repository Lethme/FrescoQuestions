...
namespace Tree
{
    ...
    public class BinaryTree<T> : IEnumerable<T> where T : IComparable<T>
    {
        ...
        public static BinaryTree<T> Create(params T[] ObjectSequence) => new BinaryTree<T>(ObjectSequence);
        /// <summary>
        /// Binary tree static cunstructor
        /// </summary>
        /// <param name="Collection">Any enumerable collection</param>
        /// <returns>Link to created binary tree object</returns>
        public static BinaryTree<T> Create(IEnumerable<T> Collection) => new BinaryTree<T>(Collection);
        #endregion
        #region Editors
        /// <summary>
        ...
        private void Add(T Object)
        {
            ...
            else
            {
                ...
                AddNode(new BinaryTreeNode<T>(Object));
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="TreeNode">New leaf to add</param>
        private void AddNode(BinaryTreeNode<T> TreeNode)
        {
            if (TreeNode == null) throw new NullReferenceException();
        ...
        private int GetHeight(BinaryTreeNode<T> Node) => Node == null ? default : FloorPass(Node).Count;
        /// <summary>
        /// Allows to get height of any subtree
        /// </summary>
        ...
        private bool IsSubtreeFull(BinaryTreeNode<T> Node)
        {
    ...
    public static class BinaryTree
    {
        ...
        /// <param name="ObjectSequence">Sequence of values</param>
        /// <returns>Link to created binary tree object</returns>
        public static BinaryTree<T> Create<T>(params T[] ObjectSequence) where T : IComparable<T> => new BinaryTree<T>(ObjectSequence);
        /// <summary>
        /// Binary tree static cunstructor
        /// </summary>
        /// <typeparam name="T">Comparable type of tree leafs values</typeparam>
        /// <param name="Collection">Any enumerable collection</param>
        /// <returns>Link to created binary tree object</returns>
        public static BinaryTree<T> Create<T>(IEnumerable<T> Collection) where T : IComparable<T> => new BinaryTree<T>(Collection);
    }
}
